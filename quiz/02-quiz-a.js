...
function insertTicket(ticket, array, times) {
...
async function orderTicket(name, price, quantity, array, times) {
    try {
        ...
        for (let i = 0; i < quantity; i++) {
            ...
            await insertTicket(ticket, array, times);
        }
...
orderTicket("Exhibition", 25, 5, tickets, 5000);
orderTicket("Contest", 30, 3, tickets, 2000);
orderTicket("Colloquium", 60, 7, tickets, 3000);
