...
const getStart = () => {
    ...
    if (registCode > 12 || isNaN(registCode)) {
        notif = `Notification : FAILED! => Sorry, the package code choice you entered is invalid..!`;
    } else {
        value = registCode;
...
const getRegister = (registCode) => {
    ...
    let value;
    if (registCode > 12 || (isNaN(registCode))) {
        notif = 'Notification : ERROR! => Sorry, Invalid Registration Number..!';
    } else {
...
const getPayment = (choosePackage) => {
    ...
    if (chooseMethod == "BCA") {
        ...
        notif = `Notification : FAILED! => Sorry, the payment method choice you entered is invalid..!`;
    }
